...
import { LayoutDashboard, Package, Tags, ShoppingBag, CreditCard, Mail, ArrowLeft, Loader2, Image, Settings, Tag, Menu, Layout, Star, Megaphone, MessageSquare } from 'lucide-react';
